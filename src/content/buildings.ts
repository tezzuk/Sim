...
export const BUILDINGS: Record<string, BuildingDef> = {
  ...
  waterReclaimer: {
    ...
    jobs: { engineer: 1 },
    powerIn: 1,
    outPerWorker: { water: 16 },
    cost: { materials: 40, influence: 8 },
    desc: 'Recycles and extracts water. One engineer covers ~17 colonists.',
  },
  electrolyzer: {
    ...base,
    name: 'Electrolyzer',
    ...
    powerIn: 2,
    waterIn: 0.8,
    outPerWorker: { oxygen: 24 },
    cost: { materials: 45, influence: 8 },
    desc: 'Splits water into breathable oxygen. One engineer covers ~20 colonists.',
  },
  greenhouse: {
    ...base,
    name: 'Greenhouse',
